    ...
    public void findAllAccounts(Customer customer) {
        ...
        for(int i = 0 ; i < checkings.get("accID").size(); i++  ){
            if(accountIDs.contains(checkings.get("accID").get(i))){
                checking = new AccountChecking(checkings.get("accID").get(i),Double.parseDouble( checkings.get("BalanceUSD").get(i))
        ...
        for(int i = 0 ; i < checkings.get("accID").size(); i++  ){
            if(accountIDs.contains(checkings.get("accID").get(i))){
                saving= new AccountChecking(checkings.get("accID").get(i),Double.parseDouble( checkings.get("BalanceUSD").get(i))
                        ,Double.parseDouble( checkings.get("BalanceEURO").get(i)),Double.parseDouble( checkings.get("BalanceRMB").get(i)));
                break;
            }
        }
        ...
        for(int i = 0 ; i < checkings.get("accID").size(); i++  ){
            if(accountIDs.contains(checkings.get("accID").get(i))){
                security= new AccountChecking(checkings.get("accID").get(i),Double.parseDouble( checkings.get("BalanceUSD").get(i))
                        ,Double.parseDouble( checkings.get("BalanceEURO").get(i)),Double.parseDouble( checkings.get("BalanceRMB").get(i)));
                break;
            }
        }
